...
<body style="background: url('/images/bgdot2.png') center/cover no-repeat;"
    class="bg-[url('/images/bgdot2.jpg')]  bg-cover bg-center  h-full md:h-screen">
    ...
    <div class="p-4 sm:ml-64 ">
        <div class="p-4 mt-20">
            <div class="w-full flex justify-center gap-4 mb-4">
                <div class="block text-start text-white">
                    <img src="/images/sys.png" class="h-20 floating-glitch" />
                    <p class="text-white text-lg mt-2 font-semibold ml-5">Instructor: Ms. Angelica Terec</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-14">
                        <!-- Card 1 -->
                        <div class="backdrop-filter backdrop-blur-sm bg-opacity-30 bg-gray-800 shadow-md rounded-lg p-4">
